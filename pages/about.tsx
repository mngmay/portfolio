...
const About: NextPage = () => {
  return (
    <>
      ...
      {/* Start of Story */}
      <Grid container spacing={2} item xs={12} className={cx('about-section')}>
        <Grid item xs={12}>
        ...
        <Grid item xs={12} sm={9} className={cx('story')}>
          ...
          <Typography>
            Without a clear life-calling, I&#39;ve learned to take every job as
            an opportunity to reflect on what aspects of work I enjoyed most and
            learn beyond the scope of my role to try new things. After getting
            to work in a few different fields such as HR and software
            development, I&#39;ve been fortunate enough to find the field of UX.
          </Typography>
          <Typography>
          ...
          <Typography>
            Besides exploring my curiousity in my professional life, I also love
            to try new creative hobbies. There&#39;s always something exciting
            to learn!
          </Typography>
          <Typography>
        ...
        <Grid container item xs={12} sm={3} className={cx('may-gallery')}>
      ...
      <Grid container item spacing={2} className={cx('about-section')}>
        <Grid item xs={12}>
        ...
        <Grid item xs={12} className={cx('support-network')}>
          <Typography>
            ...
            taken to chase new opportunities without an amazing support network.
            Endless gratitude to the people who have helped me on my journey.
          </Typography>
          <Typography>
